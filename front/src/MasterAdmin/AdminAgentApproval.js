...
const AdminAgentApproval = () => {
  ...
  useEffect(() => {
    const fetchAgents = async () => {
      try {
        const response = await axios.get("https://trcnxf.com/api/admin/agents");
  ...
  const confirmAction = async () => {
    try {
      if (actionType === "approve") {
        await axios.post(
          `https://trcnxf.com/api/admin/agents/${selectedAgent}/approve`
        );
      } else if (actionType === "decline") {
        await axios.post(
          `https://trcnxf.com/api/admin/agents/${selectedAgent}/decline`
        );
      }
