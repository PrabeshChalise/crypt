...
export default function ForgotPasswordModal({ closeModal }) {
  ...
  const handleEmailSubmit = async (e) => {
    e.preventDefault();
    try {
      await axios.post("https://trcnxf.com/api/forgot-password", {
        email,
      });
      setStep(2);
    } catch (error) {
  ...
  const handleCodeSubmit = async (e) => {
    e.preventDefault();
    try {
      const response = await axios.post("https://trcnxf.com/api/verify-code", {
        email,
  ...
  const handlePasswordSubmit = async (e) => {
    ...
    try {
      await axios.post("https://trcnxf.com/api/reset-password", {
        email,
        newPassword,
      });
